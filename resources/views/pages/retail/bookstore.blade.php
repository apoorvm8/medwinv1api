...
<section class="section-1 px-3 px-md-0">
    <div class="container">
        <h1 class="text-center mt-5">Bookstore Software</h1>
        <div class="col-sm-12">
            <p class="lead secondary-color">
                Easy billing, Import purchase, Publisher wise, Author wise,
                Genre wise reports and Fast search. All kinds of sale purchase,
                Profit reports. Accounting and GST reports available. ISBN search provided.
            </p>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row mt-5">
            <div class="col-sm-12 col-md-6 col-lg-3">
                <div class="py-3">
                    <a href="/assets/img/bookstore_soft0.jpg" data-lightbox="bookstore_bill" data-title="Image">
                        <img src="{{asset('assets/img/bookstore_soft0.jpg')}}" class="bookstore-bill" height="120"
                            width="120">
                    </a>
                </div>
                <div>
